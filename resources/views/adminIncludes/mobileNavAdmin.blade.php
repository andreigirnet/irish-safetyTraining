<div id="responsiveNavAdmin" x-data="{showEmployer: false, showAdmin:false}" x-init="console.log('init')">
    <div id="responsiveNavMenuAdmin">
        ...
        <div class="responsiveNavItem"><a href="{{route("package.index")}}">My Courses</a></div>
        ...
        <div x-show="showAdmin" x-transition>
            <div class="responsiveNavItem"><a href="{{route('users.index')}}">All Users</a></div>
            <div class="responsiveNavItem"><a href="{{route('orders.index')}}">All Orders</a></div>
            <div class="responsiveNavItem"><a href="{{route('packages.admin.index')}}">All Packages</a></div>
            <div class="responsiveNavItem"><a href="{{route('certificates.admin.index')}}">All certificates</a></div>
        </div>
        @endif
    </div>
</div>
