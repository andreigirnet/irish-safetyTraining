...
@section('content')
    ...
    <div class="trainTeamsSection">
        <div class="trainTeamsWrapper">
            ...
            <div class="teamDescription" x-html="data.contactText">Our working hours are: 10am-7pm Monday - Friday & 10am - 6pm <br> Weekend/Bank Holiday or email us to info@irish-safetytraining.com</div>
        </div>
    </div>
@endsection
